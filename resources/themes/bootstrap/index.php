...
<html>
    ...
    <head>
        ...
        <!-- STYLES -->
        <link rel="stylesheet" type="text/css" href="<?php echo THEMEPATH; ?>/css/new-css.css">
    ...
    <body> 
        <div id="page-navbar" class="navbar navbar-default navbar-fixed-top">
            ...
            <ul class="nav navbar-nav" id="sidebar">
                <li><a href="http://35.193.144.106/resources/agenda.html">Agenda</a></li>
                <li><a href="http://35.193.144.106/resources/students.html">Students Access</a></li>
		<li><a href="http://mbettan.link/HCMBootcamp" target="_blank">OneDrive</a></li>			
                <li><a href="http://mbettan.link/bootcampsurvey" target="_blank">Survey</a></li>
	    </ul>
        ...
        <div id="page-content" class="container">
            ...
            <div id="directory-list-header">
                <div class="row">
                    <div class="col-md-5 col-sm-6 col-xs-10">Labs</div>
